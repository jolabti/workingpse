...
import com.pupr.rumija.Shared.Param;
...
public class MainActivity extends AppCompatActivity{
    ...
    private static int REQUEST_WRITE_STORAGE_REQUEST_CODE =3;
    private static String webview_url   = Param.MAIN_COMPLETE_PSETK;    // web address or local file location you want to open in webview
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        webView = (WebView) findViewById(R.id.wvRumija_id);
        assert webView != null;
